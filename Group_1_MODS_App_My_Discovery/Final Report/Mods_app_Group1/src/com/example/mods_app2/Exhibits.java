...
public class Exhibits extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
	      case R.id.firstFloor:
	    	  ...
	    	  Intent FirstFloor = new Intent(arg0.getContext(),FirstFloor.class);
	      ...
	      case R.id.secondFloor:
	    	  ...
	    	  Intent SecondFloor = new Intent(arg0.getContext(),SecondFloor.class);
